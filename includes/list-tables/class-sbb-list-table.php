<?php class sbb_List_Table extends WP_List_Table
{
    ...
    public function get_columns()
    {
        $columns = array(
            ...
            'botblocked' => _x('Num Blocked', 'Column label', 'badbots'),
    ...
    protected function column_nickname($item)
    {
        ...
        $actions['desactivate'] = sprintf('<a href="%1$s">%2$s</a>', esc_url(wp_nonce_url
            (admin_url(add_query_arg($delete_query_args)), 'deletemovie_' . $item['ID'])),
            _x('Desactivate', 'List table row action', 'stopbadbots'));
    ...
    protected function get_bulk_actions()
    {
        $actions = array(
            ...
            'desactivate' => _x('Desactivate', 'List table bulk action', 'stopbadbots'),
